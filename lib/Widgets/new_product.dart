...
class new_product extends StatelessWidget {
  ...
  new_product({this.image_path, this.reviews, this.designer, this.item, this.original_price, this.rating, this.isnew, this.docid, this.favourites,});
    ...
    return GestureDetector(
      ...
      child: Column(
        ...
        children:<Widget>[
                  ...
                  Row(
                    ...
                    children:<Widget> [
                      isnew==true?Padding(
                        ...
                        child: Container(
                          child: Center(child: Text('New',style: TextStyle(color: Colors.white,fontSize: 12.0,fontFamily: kfontfamily),)),
                          decoration: BoxDecoration(
          ...
          SizedBox(height:3.0),
          Container(
            child: Text('$item',style: TextStyle(color: Colors.white,fontSize: 20.0,fontFamily: kfontfamily),overflow: TextOverflow.ellipsis,) ,
          ),
          SizedBox(height:3.0),
          Row(
            mainAxisAlignment: MainAxisAlignment.start,
