...
class fav_prod extends StatelessWidget {
  ...
  const fav_prod({this.image_path, this.rating, this.reviews, this.designer, this.item, this.original_price, this.isnew, this.docid});
  @override
      ...
      onTap: (){
        Navigator.push(context, PageRouteBuilder(
            ...
            pageBuilder: (BuildContext context, Animation<double> animation, Animation<double> secondaryAnimation){
              return product_detail(docid:docid,saleprod: false,);
            }
        ));
      },
      child: Column(
        ...
        children:<Widget>[
                  ...
                  Row(
                    ...
                    children:<Widget> [
                      isnew==true?Padding(
                        ...
                        child: Container(
                          constraints: BoxConstraints.expand(height: 20.0,width: 50.0),
                          child: Center(child: Text('New',style: TextStyle(color: Colors.white,fontSize: 13.0,fontFamily: kfontfamily),)),
                          decoration: BoxDecoration(
                      ...
                      Padding(
                        ...
                        child: Container(
                            ...
                            child: IconButton(icon: Icon(FontAwesomeIcons.times,color: Colors.white,size: 14.0,), onPressed: (){
                              FirebaseFirestore.instance.collection('products').doc(docid).update({'favourite':FieldValue.arrayRemove([FirebaseAuth.instance.currentUser.uid])});
                            })
                        ),
                      )
                    ],
          ...
          Row(
            mainAxisAlignment: MainAxisAlignment.start,
            children:<Widget> [
              Text('$original_price'+'\$',style: TextStyle(color: Colors.white.withOpacity(0.7),fontSize: 15.0,fontFamily: kfontfamily,),),
              SizedBox(width:2.0),
            ],
          ),
        ],
